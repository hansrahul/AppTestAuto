...
public class AspirationPage extends AndroidActions {
	AndroidDriver driver;

	public AspirationPage(AndroidDriver driver)// constructor
	{
...
//	(//android.widget.EditText[@resource-id="textInput"])[6]
	...
	public void setAppActivity() {
		...
		((JavascriptExecutor) driver).executeScript("mobile: startActivity",ImmutableMap.of("intent", "com.rstar.innergy/com.rstar.innergy.MainActivity"));
	...
	@AndroidFindBy(xpath = "//android.view.ViewGroup[@resource-id='__CAROUSEL_ITEM_2_READY__']/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup[2]")
	public WebElement HomeCarouselContent2;
	//android.view.ViewGroup[@resource-id="__CAROUSEL_ITEM_2_READY__"]/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup[2]
