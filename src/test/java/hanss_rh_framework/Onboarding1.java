...
public class Onboarding1 extends BaseTestInnergy {
...
//Assert.assertEquals(enka, "false");
	...
	//	Thread.sleep(20000);
		...
		driver.findElement(AppiumBy.androidUIAutomator("new UiScrollable(new UiSelector()).scrollIntoView(text(\"Trending Now\"));"));
		driver.findElement(AppiumBy.androidUIAutomator("new UiScrollable(new UiSelector()).scrollIntoView(text(\"Recommended\"));"));
