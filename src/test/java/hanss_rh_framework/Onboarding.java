...
public class Onboarding extends BaseTestInnergy {
...
//aspire.openMoodCheckinFromHome(); mood checkin home
		...
		WebDriverWait waitforViewHistory = new WebDriverWait(driver, Duration.ofSeconds(30));
		waitforViewHistory.until(ExpectedConditions
			.visibilityOfElementLocated(By.xpath("//android.widget.TextView[@text='View History']")));
		...
		driver.pressKey(new KeyEvent(AndroidKey.BACK)); driver.pressKey(new KeyEvent(AndroidKey.BACK));
